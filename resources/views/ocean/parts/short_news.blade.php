@foreach($posts as $post)
    ...
    @endphp
<div class="track-item fx-row fx-middle js-item" data-track="{{ $xf->get(config('mp3_url')) }}" data-title="{{ $song_name }}" data-artist="{{ $artist_name }}" data-img="{{ $xf->get(config('song_poster')) }}">
